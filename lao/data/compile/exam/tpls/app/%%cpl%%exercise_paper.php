...
<div id="main">
 ...
 $qrid++; ?>
                ...
                <div class="qu_content" onMouseOver="this.className='qu_content_hover'" onMouseOut="this.className='qu_content'" id="qrtion_<?php echo $questionrow['qrid']; ?>">
                	<h3><span class="float_l"><?php echo $tid; ?>、</span><?php echo html_entity_decode($questionrow['qrquestion']); ?></h3>
                	<?php $did = 0;
 ...
 $sid++; ?>
    ...
    <div id="save_prompt">
    	<h4>自动保存提示</h4>
        <p>系统将每隔<b class="red">5分钟</b>自动保存试卷及答案，答题过程中请勿刷新页面。<br />上次保存时间：<span id="lastsavetime"><?php echo date('H:i:s',TIME); ?></span></p>
    </div>
    <!--自动保存提示 结束-->
</div>
