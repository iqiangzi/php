<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\phpStudy\PHPTutorial\WWW\sy\public/../application/index\view\info.html";i:1514856944;}*/ ?>
        ...
        <td width="68%" background="/static/Images/b2.jpg">
            <table width="211" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="191" align="left" class="biao">个人信息</td>
                </tr>
            </table>
        </td>
    ...
    <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4">
        <tr>
            ...
            <td colspan="" align="left" bgcolor="#FFFFFF" class="t5">
                <div align="left">
                    <input type="text" name="username" value="<?php echo \think\Session::get('userInfo.username'); ?>"/>
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="" align="left" bgcolor="#FFFFFF" class="t5">
                <div align="left">
                    <input type="text" name="realname" value="<?php echo \think\Session::get('userInfo.realname'); ?>"/>
                </div>
            </td>
        </tr>
        <tr>
            <td height="25" align="center" bgcolor="#FFF9DF">身份</td>
            <td colspan="" align="left" bgcolor="#FFFFFF" class="t5">
                <div align="left">
        ...
        <tr>
            <td height="25" align="center" bgcolor="#FFF9DF">家庭住址</td>
            <td colspan="" align="left" bgcolor="#FFFFFF" class="t5">
                <div align="left">
                    <input type="text" name="address" value="<?php echo \think\Session::get('userInfo.address'); ?>"/>
                </div>
            </td>
        </tr>
        <tr>
            <td height="25" align="center" bgcolor="#FFF9DF">联系电话</td>
            <td colspan="" align="left" bgcolor="#FFFFFF" class="t5">
                <div align="left">
                    <input type="text" name="tel" value="<?php echo \think\Session::get('userInfo.tel'); ?>"/>
                </div>
            </td>
        </tr>
        <tr>
            <td height="25" align="center" bgcolor="#FFF9DF">个人爱好</td>
            <td colspan="" align="left" bgcolor="#FFFFFF" class="t5">
                <div align="left">
                    <input type="text" name="hobby" value="<?php echo \think\Session::get('userInfo.hobby'); ?>"/>
                </div>
            </td>
        </tr>
        <?php endif; ?>
