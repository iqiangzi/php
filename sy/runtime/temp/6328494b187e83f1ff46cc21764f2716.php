<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"C:\Users\ljx\Desktop\sy\public/../application/index\view\lab\add_lab.html";i:1514855255;}*/ ?>
        ...
        <td width="68%" background="/static/Images/b2.jpg">
            <table width="211" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="191" align="left" class="biao">添加实验室</td>
                </tr>
            </table>
        </td>
...
<form method="post" enctype="multipart/form-data" name="form1" onsubmit="return apply1();">
    <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4">
        <tr>
            <td width="86" height="25" align="center" bgcolor="#FFF9DF">实验室编号</td>
        ...
        <tr>
            <td width="86" height="25" align="center" bgcolor="#FFF9DF">实验室名称</td>
            <td colspan="5" align="left" bgcolor="#FFFFFF"><label>
        ...
        <tr>
            <td width="86" height="25" align="center" bgcolor="#FFF9DF">实验室简介</td>
            <td colspan="5" align="left" bgcolor="#FFFFFF"><label>
