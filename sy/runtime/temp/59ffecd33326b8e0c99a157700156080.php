<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpStudy\PHPTutorial\WWW\sy\public/../application/index\view\machine\add_mac.html";i:1514213112;}*/ ?>
        ...
        <td width="68%" background="/static/Images/b2.jpg">
            <table width="211" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="191" align="left" class="biao">添加设备</td>
                </tr>
            </table>
        </td>
...
<form method="post" enctype="multipart/form-data" name="form1" onsubmit="return apply1();">
    <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4">
        ...
        <tr>
            ...
            <td colspan="5" align="left" bgcolor="#FFFFFF"><label>
                <select name="lab_id">
                    ...
                    <option value="<?php echo $lab['id']; ?>" <?php if($data['lab_id'] == $lab['id']): ?>selected<?php endif; ?>><?php echo $lab['name']; ?></option>
        ...
        <tr>
            ...
            <td colspan="5" align="left" bgcolor="#FFFFFF"><label>
                &nbsp;<input name="itemname" type="text" id="itemname" size="80" value="<?php echo $data['name']; ?>"/>
            </label></td>

        </tr>

        <!--<tr>-->
            <!--<td width="86" height="25" align="center" bgcolor="#FFF9DF">编号</td>-->
            <!--<td colspan="5" align="left" bgcolor="#FFFFFF"><label>-->
                <!--&nbsp;<input name="itemname" type="text" id="num" value="<?php echo $data['num']; ?>" readonly size="80"/>-->
            <!--</label></td>-->
        ...
        <tr>
            ...
            <td colspan="5" align="left" bgcolor="#FFFFFF"><label>
                &nbsp;<textarea name="info" rows="5" cols="100" id="info" size="80"><?php echo $data['info']; ?></textarea>
            </label></td>
