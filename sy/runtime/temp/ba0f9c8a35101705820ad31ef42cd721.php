<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"C:\Users\ljx\Desktop\sy\public/../application/index\view\repair\repair_list.html";i:1514871906;}*/ ?>
        ...
        <td width="68%" background="/static/Images/b2.jpg">
            <table width="124" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="104" align="left" class="biao">报修记录</td>
                </tr>
            </table>
        </td>
...
<form method="post">
    <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4"
        ...
        <tr>
            ...
            <td align="center" bgcolor="#EFFBFE">报修人</td>
            <td align="center" bgcolor="#EFFBFE">报修时间</td>
        ...
        <?php if(is_array($repairList) || $repairList instanceof \think\Collection || $repairList instanceof \think\Paginator): $i = 0; $__LIST__ = $repairList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$repair): $mod = ($i % 2 );++$i;?>
        <tr onmouseout="this.style.backgroundColor='#ffffff'" bgcolor="#ffffff"
            onmouseover="this.style.backgroundColor='#E6F2FF'">
            <td height="25" align="center">
                <?php if(\think\Session::get('identity') == 0): ?>
                <input type="checkbox" name="id[]" value="<?php echo $repair['id']; ?>" class="ck"/>
                <?php endif; ?>
                <?php echo $key+1; ?>
            </td>
            <td height="25" align="center"><?php echo $repair['name']; ?></td>
            <td height="25" align="center"><?php echo $repair['author']; ?></td>
            <td height="25" align="center"><?php echo $repair['create_time']; ?></td>
            <td height="25" align="center"><?php echo $repair['status_name']; ?></td>
            <?php if(\think\Session::get('identity') == 0): ?>
            <td align="left">
                <div align="left" style="padding-left:5px">
                    <div align="center">
                        <a href="/index/repair/handling?id=<?php echo $repair['id']; ?>" onclick="return confirm('确认处理？')">处理</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/index/repair/repaired?id=<?php echo $repair['id']; ?>" onclick="return confirm('是否确认？')">确认维修</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/index/repair/delete?id=<?php echo $repair['id']; ?>" onclick="return confirm('确认删除该报修记录？')">删除</a>
                    </div>
                </div>
            </td>
            <?php endif; ?>
        ...
        <tr width="5%" height="25" align="center" bgcolor="#EFFBFE">
            ...
            <?php endif; ?>
            <td colspan="6">
                <div class="list-page"><?php echo $repairList->render(); ?></div>
            </td>
        </tr>
    </table>
</form>
