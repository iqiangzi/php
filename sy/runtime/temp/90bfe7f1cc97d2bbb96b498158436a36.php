<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpStudy\PHPTutorial\WWW\sy\public/../application/index\view\machine\mac_list.html";i:1514871906;}*/ ?>
...
<form method="post">
    <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4"
        ...
        <?php if(is_array($machineList) || $machineList instanceof \think\Collection || $machineList instanceof \think\Paginator): $i = 0; $__LIST__ = $machineList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mac): $mod = ($i % 2 );++$i;?>
        <tr onmouseout="this.style.backgroundColor='#ffffff'" bgcolor="#ffffff"
            onmouseover="this.style.backgroundColor='#E6F2FF'">
            <td height="25" align="center">
                <?php if(\think\Session::get('identity') == 0): ?>
                <input type="checkbox" name="id[]" value="<?php echo $mac['id']; ?>" class="ck"/>
                <?php endif; ?>
                <?php echo $key+1; ?>
            </td>
            <td height="25" align="center"><?php echo $mac['name']; ?></td>
            <td height="25" align="center">J<?php echo $mac['num']; ?></td>
            <td height="25" align="center"><?php echo $mac['lname']; ?></td>
            <td height="25" align="center"><?php echo $mac['info']; ?></td>
            <td height="25" align="center"><?php echo $mac['status_name']; ?></td>
            <?php if(\think\Session::get('identity') == 0): ?>
            <td align="left">
                <div align="left" style="padding-left:5px">
                    <div align="center">
                        <?php if($mac['status'] == 0): ?>
                        <a href="/index/machine/edit?id=<?php echo $mac['id']; ?>">修改</a>
                        <a href="/index/machine/destroy?id=<?php echo $mac['id']; ?>" onclick="return confirm('确认要报废吗？')">设备报废</a>
                        <?php endif; ?>
                        <a href="/index/machine/delete?id=<?php echo $mac['id']; ?>" onclick="return confirm('确认要删除吗？')">删除</a>
                    </div>
                </div>
            </td>
            <?php endif; ?>
        ...
        <tr width="5%" height="25" align="center" bgcolor="#EFFBFE">
            ...
            <?php endif; ?>
            <td colspan="8">
                <div class="list-page"><?php echo $machineList->render(); ?></div>
            </td>
        </tr>
    </table>
</form>
