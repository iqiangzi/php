<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"C:\Users\ljx\Desktop\sy\public/../application/index\view\affiche\announce_list.html";i:1514871871;}*/ ?>
        ...
        <td width="68%" background="/static/Images/b2.jpg">
            <table width="124" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="104" align="left" class="biao">公告列表</td>
                </tr>
            </table>
        </td>
...
<form method="post">
    <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4"
        ...
        <tr>
            ...
            <td align="center" bgcolor="#EFFBFE">标题</td>
            <td align="center" bgcolor="#EFFBFE">内容</td>
            <td align="center" bgcolor="#EFFBFE">更新时间</td>
            <?php if(\think\Session::get('identity') == 0): ?>
            <td align="center" bgcolor="#EFFBFE">管理操作</td>
            <?php endif; ?>
        </tr>
        <?php if(is_array($afficheList) || $afficheList instanceof \think\Collection || $afficheList instanceof \think\Paginator): $i = 0; $__LIST__ = $afficheList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$affiche): $mod = ($i % 2 );++$i;?>
        <tr onmouseout="this.style.backgroundColor='#ffffff'" bgcolor="#ffffff"
            onmouseover="this.style.backgroundColor='#E6F2FF'">
            <td height="25" align="center">
                <?php if(\think\Session::get('identity') == 0): ?>
                <input type="checkbox" name="id[]" value="<?php echo $affiche['id']; ?>" class="ck"/>
                <?php endif; ?>
                <?php echo $key+1; ?>
            </td>
            <td height="25" align="center"><?php echo $affiche['title']; ?></td>
            <td height="25" align="center"><?php echo $affiche['content']; ?></td>
            <td height="25" align="center"><?php echo $affiche['update_time']; ?></td>
            <?php if(\think\Session::get('identity') == 0): ?>
            <td align="left">
                <div align="left" style="padding-left:5px">
                    <div align="center">
                        <a href="/index/affiche/edit?id=<?php echo $affiche['id']; ?>">修改</a>
                        <a href="/index/affiche/delete?id=<?php echo $affiche['id']; ?>" onclick="return confirm('确认要删除吗？')">删除</a>
                    </div>
                </div>
            </td>
            <?php endif; ?>
        ...
        <tr width="5%" height="25" align="center" bgcolor="#EFFBFE">
            ...
            <?php endif; ?>
            <td colspan="5">
                <div class="list-page"><?php echo $afficheList->render(); ?></div>
            </td>
        </tr>
    </table>
</form>
