...
<div id="main">
	...
	<form action="register.php?action=register" method="post" name="register" enctype="multipart/form-data" >
		<dl>
			...
			<dd>出生年月：<select name="birth_y"><?php for($i=1980;$i<=2000;$i++)echo "<option value=$i>$i</option>";?></select>年<select name="birth_m"><?php for($i=1;$i<=12;$i++)echo "<option value=$i>$i</option>";?></select>月<select name="birth_d"><?php for($i=1;$i<=31;$i++)echo "<option value=$i>$i</option>";?>
</select>日</dd>
			<dd>入学时间：<select name="start_time_y"><?php for($i=2000;$i<=2019;$i++)echo "<option value=$i>$i</option>";?></select>年<select name="start_time_m"><?php for($i=1;$i<=12;$i++)echo "<option value=$i>$i</option>";?></select>月<select name="start_time_d"><?php for($i=1;$i<=31;$i++)echo "<option value=$i>$i</option>";?>
</select>日</dd>
