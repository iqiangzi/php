						...
						<tr>
							...
							<td>
								<div class="btn-group">
									...
									<a class="btn ajax" href="index.php?exam-master-rowsquestions-delchildquestion&questionparent=<?php echo $this->tpl_var['question']['qrid']; ?>&page=<?php echo $this->tpl_var['page']; ?>&questionid=<?php echo $question['questionid']; ?><?php echo $this->tpl_var['u']; ?>" title="删除"><em class="icon-remove"></em></a>
		                    	</div>
							</td>
						</tr>
						<?php } ?>
