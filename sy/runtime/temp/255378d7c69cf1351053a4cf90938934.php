<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"C:\Users\ljx\Desktop\sy\public/../application/index\view\attendance\add_attend.html";i:1514213137;}*/ ?>
        ...
        <td width="68%" background="/static/Images/b2.jpg">
            <table width="211" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="191" align="left" class="biao">考勤打卡</td>
                </tr>
            </table>
        </td>
...
<form method="post" enctype="multipart/form-data" name="form1" onsubmit="return apply1();">
    <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4">
        ...
        <tr>
            ...
            <td colspan="2" height="25" align="center" bgcolor="#FFFFFF"><label>
                <button type="submit" class="button button2">打卡</button>
            </label></td>
