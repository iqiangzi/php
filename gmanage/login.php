...
<body style="background-image: url(images/bj.gif);">
...
<h1><img src="images/loginlogo.png" alt="计算机学院" /></h1>
	<form name="login" method="post" action="login.php?action=login">	
		<dl>
			<dt></dt>
			<dd><!--<label for="num" >用户名：</label>-->
			<input type="text" name="num" class="text" id="num" placeholder="用户名"/></dd>
			
			
			<dd><!--<label for="password"> 密　码：</label>-->
			<input type="password" name="password" class="text" id="password" placeholder="密码"/></dd>
			
			<?php if($_system['needcode']==1){echo "<dd><label for='code1'></label><input type='text' name='code' class='text code' placeholder=验证码 id='code1' /> <img src='code.php' id='code' /></dd>";}?>
			
			<dd><input type="submit" value="登 录" class="button" name="submit"/>
			<input type="button" value="注 册" class="button" onclick="location.href='register.php'" /></dd>
