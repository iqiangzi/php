<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"C:\Users\ljx\Desktop\sy\public/../application/index\view\lab\lab_list.html";i:1514871906;}*/ ?>
    ...
    <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4"
        ...
        <tr onmouseout="this.style.backgroundColor='#ffffff'" bgcolor="#ffffff"
            ...
            <td height="25" align="center">
                <?php if(\think\Session::get('identity') == 0): ?>
                <input type="checkbox" name="id[]" value="<?php echo $lab['id']; ?>" class="ck"/>
                <?php endif; ?>
                <?php echo $key+1; ?>
            </td>
            <td height="25" align="center"><?php echo $lab['name']; ?></td>
            <td height="25" align="center"><?php echo $lab['no']; ?></td>
            <td height="25" align="center"><?php echo $lab['info']; ?></td>

            <td align="left">
                <div align="left" style="padding-left:5px">
                    <div align="center">
                        <?php if(\think\Session::get('identity') == 0): ?>
                        <a href="/index/classtable/add?id=<?php echo $lab['id']; ?>">添加课表</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <?php endif; ?>
                        <a href="/index/classtable/index?id=<?php echo $lab['id']; ?>">查看课表</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <?php if(\think\Session::get('identity') == 0): ?>
                        <a href="/index/lab/edit?id=<?php echo $lab['id']; ?>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/index/lab/delete?id=<?php echo $lab['id']; ?>" onclick="return confirm('确认要删除吗？')">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <?php endif; ?>
                    </div>
                </div>
            </td>
        ...
        <tr width="5%" height="25" align="center" bgcolor="#EFFBFE">
            ...
            <?php endif; ?>
            <td colspan="4">
                <div class="list-page"><?php echo $labList->render(); ?></div>
            </td>
        </tr>
