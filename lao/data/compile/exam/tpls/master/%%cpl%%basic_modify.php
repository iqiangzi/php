					...
					<div class="controls">
						<div class="thumbuper pull-left">
							<div class="thumbnail">
								...
								<div class="boot"><img src="app/core/styles/images/noimage.gif" id="catimg_view"/><input type="hidden" name="args[basicthumb]" value="<?php echo $this->tpl_var['basic']['basicthumb']; ?>" id="catimg_value"/></div>
							</div>
						</div>
					</div>
				</div>
