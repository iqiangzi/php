...
<div id="main">
	<form action="stu_data_edit.php" method="post" enctype="multipart/form-data" >
		...
		<dl>
			...
			<dd>出生年月：<select name="birth_y"><?php for($i=1980;$i<=2000;$i++){if($birth[0]==$i)echo "<option value=$i selected='selected'>$i</option>";else echo "<option value=$i>$i</option>";}?></select>年<select name="birth_m"><?php for($i=1;$i<=12;$i++){if($birth[1]==$i)echo "<option value=$i selected='selected'>$i</option>";else echo "<option value=$i>$i</option>";}?></select>月<select name="birth_d"><?php for($i=1;$i<=31;$i++){if($birth[2]==$i)echo "<option value=$i selected='selected'>$i</option>";else echo "<option value=$i>$i</option>";}?>
</select>日</dd>
			<dd>入学时间：<select name="start_time_y"><?php for($i=2000;$i<=2019;$i++){if($start[0]==$i)echo "<option value=$i selected='selected'>$i</option>";else echo "<option value=$i>$i</option>";}?></select>年<select name="start_time_m"><?php for($i=1;$i<=12;$i++){if($start[1]==$i)echo "<option value=$i selected='selected'>$i</option>";else echo "<option value=$i>$i</option>";}?></select>月<select name="start_time_d"><?php for($i=1;$i<=31;$i++){if($start[2]==$i)echo "<option value=$i selected='selected'>$i</option>";else echo "<option value=$i>$i</option>";}?>
</select>日</dd>
